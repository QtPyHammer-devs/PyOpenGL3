...
import ctypes
_EXTENSION_NAME = "GL_EXT_texture_compression_s3tc"
def _f(function):
    return _p.createFunction(function,_p.PLATFORM.GL,"GL_EXT_texture_compression_s3tc",error_checker=_errors._error_checker)
