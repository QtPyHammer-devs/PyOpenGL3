...
import ctypes
_EXTENSION_NAME = "GL_MESA_framebuffer_flip_y"
def _f(function):
    return _p.createFunction(function,_p.PLATFORM.GL,"GL_MESA_framebuffer_flip_y",error_checker=_errors._error_checker)
