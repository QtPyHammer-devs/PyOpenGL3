...
import ctypes
_EXTENSION_NAME = "GL_NV_shading_rate_image"
def _f(function):
    return _p.createFunction(function,_p.PLATFORM.GL,"GL_NV_shading_rate_image",error_checker=_errors._error_checker)
