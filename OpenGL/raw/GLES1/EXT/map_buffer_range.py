...
import ctypes
_EXTENSION_NAME = "GLES1_EXT_map_buffer_range"
def _f(function):
    return _p.createFunction(function,_p.PLATFORM.GLES1,"GLES1_EXT_map_buffer_range",error_checker=_errors._error_checker)
