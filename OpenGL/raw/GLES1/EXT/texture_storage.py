...
import ctypes
_EXTENSION_NAME = "GLES1_EXT_texture_storage"
def _f(function):
    return _p.createFunction(function,_p.PLATFORM.GLES1,"GLES1_EXT_texture_storage",error_checker=_errors._error_checker)
