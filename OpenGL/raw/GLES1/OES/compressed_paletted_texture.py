...
import ctypes
_EXTENSION_NAME = "GLES1_OES_compressed_paletted_texture"
def _f(function):
    return _p.createFunction(function,_p.PLATFORM.GLES1,"GLES1_OES_compressed_paletted_texture",error_checker=_errors._error_checker)
