...
import ctypes
_EXTENSION_NAME = "GLES1_QCOM_extended_get"
def _f(function):
    return _p.createFunction(function,_p.PLATFORM.GLES1,"GLES1_QCOM_extended_get",error_checker=_errors._error_checker)
