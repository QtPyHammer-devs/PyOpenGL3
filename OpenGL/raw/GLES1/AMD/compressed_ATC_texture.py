...
import ctypes
_EXTENSION_NAME = "GLES1_AMD_compressed_ATC_texture"
def _f(function):
    return _p.createFunction(function,_p.PLATFORM.GLES1,"GLES1_AMD_compressed_ATC_texture",error_checker=_errors._error_checker)
