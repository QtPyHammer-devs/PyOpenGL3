...
import ctypes
_EXTENSION_NAME = "GLES2_NV_framebuffer_multisample"
def _f(function):
    return _p.createFunction(function,_p.PLATFORM.GLES2,"GLES2_NV_framebuffer_multisample",error_checker=_errors._error_checker)
