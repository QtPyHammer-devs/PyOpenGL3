...
import ctypes
_EXTENSION_NAME = "GLES2_EXT_EGL_image_storage"
def _f(function):
    return _p.createFunction(function,_p.PLATFORM.GLES2,"GLES2_EXT_EGL_image_storage",error_checker=_errors._error_checker)
