...
import ctypes
_EXTENSION_NAME = "GLES2_EXT_semaphore_win32"
def _f(function):
    return _p.createFunction(function,_p.PLATFORM.GLES2,"GLES2_EXT_semaphore_win32",error_checker=_errors._error_checker)
