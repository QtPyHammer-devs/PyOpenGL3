...
import ctypes
_EXTENSION_NAME = "GLES2_EXT_texture_compression_s3tc"
def _f(function):
    return _p.createFunction(function,_p.PLATFORM.GLES2,"GLES2_EXT_texture_compression_s3tc",error_checker=_errors._error_checker)
