...
import ctypes
_EXTENSION_NAME = "GLES2_KHR_texture_compression_astc_hdr"
def _f(function):
    return _p.createFunction(function,_p.PLATFORM.GLES2,"GLES2_KHR_texture_compression_astc_hdr",error_checker=_errors._error_checker)
