...
import ctypes
_EXTENSION_NAME = "GLES2_AMD_framebuffer_multisample_advanced"
def _f(function):
    return _p.createFunction(function,_p.PLATFORM.GLES2,"GLES2_AMD_framebuffer_multisample_advanced",error_checker=_errors._error_checker)
