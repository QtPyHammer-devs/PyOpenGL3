...
import ctypes
_EXTENSION_NAME = "GLES2_OES_required_internalformat"
def _f(function):
    return _p.createFunction(function,_p.PLATFORM.GLES2,"GLES2_OES_required_internalformat",error_checker=_errors._error_checker)
