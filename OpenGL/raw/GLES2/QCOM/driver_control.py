...
import ctypes
_EXTENSION_NAME = "GLES2_QCOM_driver_control"
def _f(function):
    return _p.createFunction(function,_p.PLATFORM.GLES2,"GLES2_QCOM_driver_control",error_checker=_errors._error_checker)
