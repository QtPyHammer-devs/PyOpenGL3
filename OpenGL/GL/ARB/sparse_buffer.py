"""OpenGL extension ARB.sparse_buffer
...
from OpenGL.raw.GL.ARB.sparse_buffer import *
from OpenGL.raw.GL.ARB.sparse_buffer import _EXTENSION_NAME

def glInitSparseBufferARB():
