...
class ModuleGenerator(object):
    ...
    def raw_module(self):
        out = "\n".join(['"""Autogenerated by xml_generate script, do not edit!"""',
                         ...
                         "# End users want this...",
                         f"from OpenGL.raw.{self.prefix}._types import *",
    ...
    INIT_TEMPLATE = """def glInit%(camelModule)s%(owner)s():
    "Return boolean indicating whether this extension is available"
    from OpenGL import extensions
    return extensions.hasGLExtension(_EXTENSION_NAME)"""

    FINAL_MODULE_TEMPLATE = "\n".join([f'"""OpenGL extension {owner}.{module}',
                                       "This module customises the behaviour of the",
                                       f"OpenGL.raw.{prefix}.{owner}.{module} to provide a more Python-friendly API",
                                       f"{overview}The official definition of this extension is available here:",
                                       f'{ROOT_EXTENSION_SOURCE}{owner}/{module}.txt"""',  # end docstring
                                       "import ctypes",
                                       "",  # break a line between builtins & local imports
                                       "from OpenGL import platform, constant, arrays",
                                       "from OpenGL import extensions, wrapper",
                                       f"from OpenGL.raw.{prefix} import _types, _glgets",
                                       f"from OpenGL.raw.{prefix}.{owner}.{module} import *",
                                       f"from OpenGL.raw.{prefix}.{owner}.{module} import _EXTENSION_NAME",
                                       f"{init_function}",
                                       f"{output_wrapping}"])
    ...
    def init_function(self):
        return self.INIT_TEMPLATE % self  # calculate f-string
