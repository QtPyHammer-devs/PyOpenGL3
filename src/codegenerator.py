...
%(elements)s"""  # substitute with f-strings & a function
...
%(declarations)s"""
    ...
    INIT_TEMPLATE = R"""def glInit%(camelModule)s%(owner)s():
    "Return boolean indicating whether this extension is available"
    from OpenGL import extensions
    return extensions.hasGLExtension(_EXTENSION_NAME)"""

    FINAL_MODULE_TEMPLATE = R"""'OpenGL extension %(owner)s.%(module)s
